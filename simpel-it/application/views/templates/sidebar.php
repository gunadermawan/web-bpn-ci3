<!-- Sidebar -->
<ul style="background-color:#2D2A70; border-top-right-radius:30px; border-bottom-right-radius:30px;" class="navbar-nav sidebar sidebar-dark accordion " id="accordionSidebar">
  <!-- Sidebar - Brand -->
  <a class="sidebar-brand d-flex align-items-center justify-content-center">
    <!-- <div class="sidebar-brand-icon">
          <i class="fas fa-office" style="color:#ed6b23;"></i>
      </div> -->
    <div class="sidebar-brand-text mx-3">PT. SMI</div>
  </a>
  <!-- Divider -->
