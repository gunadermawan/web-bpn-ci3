<div class="col-12 text-center mb-10">
	...
	<hr class="one" style="height: 5px;width: 40vh;border-radius: 20px;background: linear-gradient(to right, #2D2A70,#ed6b23);"><br>
</div>
<!-- form pencarian data -->
  <div class="container">
		...
		<div>
			<h6>Menampilkan sebanyak <span class="badge badge-pill " style="background-color:#ed6b23;color:#ffff"><?= $total_rows; ?></span> data.<?= $this->session->flashdata('message'); ?></h6>
		</div>

  </div>
<div class="container-fluid md-6 sm-12">
    <a href="<?= base_url('user/tambahdata'); ?>"><button class="btn btn-sm mb-3"style="background-color:#2D2A70; color:#ffff; border-radius:20px; width:120px;" ><i class="fas fa-plus fa-sm" ></i> Tambah Data</button></a>
