...
<div class="container-fluid">
  <div class="alert alert-success" role="alert">
    <h4 class="alert-heading">Hai <?= $user['name']; ?> !</h4>
      ...
      <p>Selamat datang di aplikasi Sistem Informasi Manajemen Perlengkapan IT (SIMPEL IT) UPT.BALAI YASA TEGAL</p>
    <hr>
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-12 mb-3">
    		<div class="card bg-primary text-white">
    			<div class="card-body">
    				<div class="card-title"><h4> <i class="fas fa-database"></i> <?= $total_rows; ?> Data asset tersedia.</h4></div>
      ...
      <div class="col-md-4 col-sm-6 mb-3">
    		<div class="card bg-warning text-white">
    			<div class="card-body">
    				<div class="card-title"><h4> <i class="fas fa-users"></i> total <?= $total_rows_user; ?> Pengguna terdaftar</h4></div>
      ...
      <div class="col-md-4 col-sm-12 mb-3">
        <div class="card bg-primary text-white">
          <div class="card-body">
            <div class="card-title"><h4> <i class="fas fa-code"></i> Sistem Modulasi</h4></div>
    	...
    	<div class="col-md-4 col-sm-6 mb-3">
    		<div class="card bg-warning text-white">
    			<div class="card-body">
    				<div class="card-title"><h4> <i class="fas fa-key"></i> Enkripsi untuk Privasi</h4></div>
    	...
    	<div class="col-md-4 col-sm-6 mb-3">
    		<div class="card bg-info text-white">
    			<div class="card-body">
    				<div class="card-title"><h4> <i class="fas fa-database"></i> Perlindungan Database dari serangan CSRF</h4></div>
