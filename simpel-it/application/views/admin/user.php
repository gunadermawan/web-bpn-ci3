<div class="col-12 text-center mb-10">
  ...
  <div class="container-fluid">
      <a href="<?= base_url('admin/register'); ?>"><button class="btn btn-sm mb-3"style="background-color:#2D2A70; color:#ffff; border-radius:20px; width:150px;" ><i class="fas fa-plus fa-sm" ></i> Tambah Pengguna</button></a>
